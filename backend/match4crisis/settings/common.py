"""
Django settings for match4crisis project.
...
ROOT_URLCONF = "match4crisis.urls"
...
LOGGING = {
    ...
    "formatters": {
        "json": {  # Made for Django Requests and General logging, will create parseable error logs
            "class": "match4crisis.logging.formatters.DjangoRequestJSONFormatter"
        },
        "text": {
            "class": "match4crisis.logging.formatters.OneLineExceptionFormatter",
    ...
    "handlers": {
        ...
        "errorlogfile": {
            ...
            "formatter": "json",
            "level": "ERROR",
            "filename": path.join(RUN_DIR, "match4crisis.json.error.log"),
        ...
        "auditlogfile": {
            ...
            "formatter": "json",
            "level": "INFO",
            "filename": path.join(RUN_DIR, "match4crisis.json.audit.log"),
            "maxBytes": 1024 * 1024 * 15,  # 15MB
            "backupCount": 10,
        },
        "discord": {
...
# ========== determine wether this is a forked version of m4c ==========#
...
if IS_TRAVIS and os.environ["TRAVIS_PULL_REQUEST_SLUG"] is ["RogerPenrose/match4crisis"]:
    IS_FORK = True
